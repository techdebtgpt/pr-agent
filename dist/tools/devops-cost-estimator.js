 ...
 */
export function isDevOpsFile(filePath) {
 ...
 */
function extractCloudFormationResources(content) {
    const resources = [];
 ...
 */
export function formatCostEstimates(estimates, totalCost) {
...
//# sourceMappingURL=devops-cost-estimator.js.map