 ...
 */
import { searchArchDocs } from './arch-docs-parser.js';
/**
 * Build context from arch-docs based on PR analysis needs
 */
export function buildArchDocsContext(docs, prContext) {
    if (docs.length === 0) {
        return {
            available: false,
            summary: '',
 ...
 */
export function formatArchDocsForPrompt(context) {
 ...
 */
export function getSecurityContext(docs) {
 ...
 */
export function getArchitectureContext(docs) {
 ...
 */
export function getPatternsContext(docs) {
...
//# sourceMappingURL=arch-docs-rag.js.map